...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.fondo_default = "Python/PYQT/8/fondo.png"
    ...
    def inicializarUI(self):
        ...
        self.create_background("Python/PYQT/8/fondo.png")
    ...
    def generate_settings_tab(self):
        ...
        Button_fondo1.clicked.connect(lambda: self.create_background("Python/PYQT/6/espana.png"))

        Button_fondo2 = QPushButton()
        Button_fondo2.setObjectName("button_F2")
        Button_fondo2.setFixedSize(155, 100)
        Button_fondo2.clicked.connect(lambda: self.create_background("Python/PYQT/8/fondo2.jpeg"))

        Button_fondo3 = QPushButton()
        Button_fondo3.setObjectName("button_F3")
        Button_fondo3.setFixedSize(160, 100)
        Button_fondo3.clicked.connect(lambda: self.create_background("Python/PYQT/8/fondo3.jpg"))

        Button_fondo4 = QPushButton()
        Button_fondo4.setObjectName("button_F4")
        Button_fondo4.setText("Default")
